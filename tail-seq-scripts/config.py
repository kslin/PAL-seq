...
NUM_SKIP, NUM_SKIP_2 = 10, 5 # number of nucleotides to skip in the beginning of read 1 or end of read 2, respectively, when normalizing intensities (usually 10 and 5)

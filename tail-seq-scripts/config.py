...
NUM_SKIP = 10 # number of nucleotides to skip when normalizing intensities USUALLY 10, 14 for DIR
...
FASTQ_GZIP = 'Else' #if false, extension is .txt, if True extension is .txt.gz, else extension is .tar.gz
TRIM_BASES = 0 #Should be set to 0 for a splint ligation, 4 or 8 for a direct lig run. 
